            ...
            <div class="card col-3 p-0 m-3 shadow">
              ...
              <div class ="content bg-light p-3">
                <ul class="list-group list-group">
                  ...
                  <li class="list-group-item">E-mail: <a href="mailto:${Interns.email}">${intern.email}</a></li>
            ...
            <div class="card col-3 p-0 m-3 shadow">
              <div class="card-header bg-info">
                ...
                <div class="d-flex d-inline">  
                  ...
                  <h3 class="ms-3">${Engineers.role}</h3>
                </div>
              </div>
              ...
              <div class ="content bg-light p-3">
                <ul class="list-group list-group">
                  ...
                  <li class="list-group-item">E-mail: <a href="mailto:${Engineers.email}">${engineer.email}</a></li>
            ...
            <div class="card col-3 p-0 m-3 shadow">
              <div class="card-header bg-info">
                ...
                <path d="M1 2a1 1 0 0 1 1-1h11a1 1 0 0 1 1 1v1h.5A1.5 1.5 0 0 1 16 4.5v7a1.5 1.5 0 0 1-1.5 1.5h-.55a2.5 2.5 0 0 1-2.45 2h-8A2.5 2.5 0 0 1 1 12.5V2zm13 10h.5a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.5-.5H14v8z"/>
                  ...
                  <h3 class="ms-3">${Managers.role}</h3>
                </div>
              </div>
              ...
              <div class ="content bg-light p-3">
                <ul class="list-group list-group">
                  ...
                  <li class="list-group-item">E-mail: <a href="mailto:${Managers.email}">${manager.email}</a></li>
